...
def holding_room()
	...
	Do you try to [br]eak the chains, or just [wa]it for a better opportunity?
...
TEXT
  ...
  if action.include? "br"
	...
	Do you try to [at]tack your captors straight away, or do you [hi]de in the shadows?
...
TEXT
  ...
  if action.include? "at"
	...
	enough time to pull out his laser gun, which he uses to fill you full of holes. 
...
TEXT
	...
	"Where on earth is he?" asks one of the men, as they both have their backs 
...
TEXT
	...
	puts "What? I couldn't understand what you mean."
	return :holding_room
  end
  end
...
TEXT
	...
	called VA-SAN-T, which you have never heard of before. Before you can check any 
...
TEXT
	...
	importantly, you will never find out what project VA-SAN-T is, and why 
...
TEXT
	...
	"#{@name}, you idiot," says the man with the white coat, coughing. 
...
TEXT
	...
	decipher_code = "VA-SAN-T".split("").shuffle.join
	puts decipher_code
	puts()
...
TEXT
	...
	VA-SAN-T is all about, but you were close...
...
TEXT
	  ...
	  if action
	    puts "Phew, you got out of this mess. Good job! "
	    puts()
	    $sector=3; 
          puts "You're now in the 3rd sector. Don't worry, you just went through the hardest
          play();
          return :exit
